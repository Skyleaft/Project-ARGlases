...
{
    [Header("shape")] public TextMeshProUGUI shape;
    public TextMeshProUGUI shapepercent;
    public Slider shapeslider;

    [Header("gender")] public TextMeshProUGUI gender;
    ...
    public void SetUIValue(CapturedFace faces)
    {
        if (faces != null)
        {
            ...
            if (faces.genderPrediction != null)
            {
                ...
                if (faces.genderPrediction.Gender.Contains("Female") &&
                    faces.genderPrediction.Confidence < 0.2)
                    gendertext = "Pria";
                faces.genderPrediction.Gender = gendertext;
